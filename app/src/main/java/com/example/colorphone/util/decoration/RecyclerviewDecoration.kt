package com.colorphone.callscreen.util.decoration
...
class RecyclerviewDecoration(
    ...
    @ColorInt colorActive: Int) : RecyclerView.ItemDecoration() {
...
init {
    ...
    indicatorItemPadding = padding.roundToInt()
    this.indicatorHeight = indicatorHeight.roundToInt()
}
